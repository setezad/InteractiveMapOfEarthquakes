...
public class EarthquakeCityMap extends PApplet {
	...
	//	simpleMarker.setRadius(10);
		...
		if(mag<4){
			...
			simpleMarker.setRadius(6);
		}
		else if(mag>=4 && mag<5){
			simpleMarker.setColor(yellow);
			simpleMarker.setRadius(8);
		}
		else if(mag>=5){
	...
	{	
		...
		//
		fill(255,0,0);
		ellipse(45,100,10,10);		// radius = 10
		textSize(15);
		fill(0,0,0);
		text("5.0+ Maginutde",60,105);
		//
		fill(255,255,0);
		ellipse(45,135,8,8);
		fill(0,0,0);
		text("4-4.9 Magnitude",60,140);
		//
		fill(0,0,255);
		ellipse(45,165,6,6);
		fill(0,0,0);
		text("Below 4.0",60,170);
