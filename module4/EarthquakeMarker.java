...
public abstract class EarthquakeMarker extends SimplePointMarker
{
	...
	private void colorDetermine(PGraphics pg) {
		...
		int blue = pg.color(0, 0, 223);
		int yellow = pg.color(220,220,0);
		if(this.getDepth()>=THRESHOLD_INTERMEDIATE){
			//this.setColor(blue); // this method does not work here (why?!)
			pg.fill(0,0,255);
			//System.out.println(Float.toString(this.getDepth()));
		}
